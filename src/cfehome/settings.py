...
MANAGERS = []
ADMINS = []
# all toma un iterable y retorna True solo si todos los elementos dentro de ella son 'verdaderos' truthies
...
# Es la direccion web de los archivos estaticos
# Si es /static/ el navegador buscará midominio.com/static/...
STATIC_URL = "static/"
